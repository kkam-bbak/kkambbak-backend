...
public class RoleplayController {
    ...
    //롤플레이 시나리오 조회 API
    @GetMapping("/all")
    public ApiResponse<List<RoleplayListResponseDto>> getAllRoleplayScenarios(@AuthenticationPrincipal UserDetailsImpl user) {
        List<RoleplayListResponseDto> allRoleplayScenarios = roleplayService.getAllRoleplayScenarios();
